...
import FormLangganan.Langganan;
...
public class popuppelanggan extends javax.swing.JFrame {
    ...
    try {
      String sql = "SELECT * FROM pelanggan where id_pelanggan like '%"+cariitem+"%' or nama_pel like '%"+cariitem+"%' order by id_pelanggan asc";
    ...
    private void tblplgnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblplgnMouseClicked
       int tabelPelanggan = tblplgn.getSelectedRow();
        ...
        plgn.telp = tblplgn.getValueAt(tabelPelanggan, 2).toString();
