...
char defaultEcho;
    ...
    private void initComponents() {
        ...
        jPanelKiri.setBackground(new java.awt.Color(51, 51, 51));
        ...
        jpw.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jLogo.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\Icon\\Putra.Net2.png")); // NOI18N
                ...
                .addGroup(jPanelKiriLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelKiriLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelKiriLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(show))))
                .addGap(18, 18, 18)
                .addComponent(blog, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtnmFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtnmFocusLost
        if (txtnm.getText().equals("")) {
            txtnm.setText("Masukkan Username");
        }
    ...
    private void txtnmFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtnmFocusGained
        if (String.valueOf(txtnm.getText()).equals("Masukkan Username")) {
            txtnm.setText("");
        }
