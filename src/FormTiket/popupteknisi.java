...
public class popupteknisi extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(popupteknisi.class.getName());
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;

    public tiket tkn = null;
    ...
    Object[] Baris = {"ID Teknisi", "Nama Teknisi", "No Hp", "Spesialis", "Status"};
    tabmode = new DefaultTableModel(null, Baris);

    String cariitem = txtcari.getText();

    try {
       String sql = "SELECT * FROM teknisi where id_teknisi like '%" + cariitem +
    ...
    private void tblteknisiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblteknisiMouseClicked
       int tabelTeknisi = tblteknisi.getSelectedRow();

        tkn.nama = tblteknisi.getValueAt(tabelTeknisi, 1).toString();
        tkn.spesialis = tblteknisi.getValueAt(tabelTeknisi, 3).toString();
        tkn.id = tblteknisi.getValueAt(tabelTeknisi, 0).toString(); 
        tkn.itemTerpilihtekn();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new popupteknisi().setVisible(true));
    }
