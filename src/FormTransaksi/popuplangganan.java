...
import FormTransaksi.Transaksii;
import koneksi.koneksi;
public class popuplangganan extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(popuplangganan.class.getName());
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;

    public Transaksii plgn = null;
  
    

    public popuplangganan() {
        initComponents();
         datatable();
    }
    ...
    try {
       String sql = "SELECT * FROM langganan where id_langganan like '%" + cariitem +
                     "%' order by id_langganan asc";
    ...
    private void tblplgnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblplgnMouseClicked
       int tabelPelanggan = tblplgn.getSelectedRow();
        ...
        plgn.tgl = tblplgn.getValueAt(tabelPelanggan, 2).toString();
        plgn.paket = tblplgn.getValueAt(tabelPelanggan, 3).toString();
        plgn.harga = tblplgn.getValueAt(tabelPelanggan, 4).toString();
        plgn.teknisi = tblplgn.getValueAt(tabelPelanggan, 5).toString();
        plgn.router = tblplgn.getValueAt(tabelPelanggan, 6).toString();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new popuplangganan().setVisible(true));
    }
